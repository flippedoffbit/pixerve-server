...
📚 **[Extending Pixerve](EXTENDING.md)** - Learn how to add new image formats and storage backends
...
- **Graceful Shutdown**: SIGINT/SIGTERM handling with 30s timeout for clean resource cleanup
